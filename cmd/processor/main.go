...
// 	log.Println("Informacion del entorno:")

// 	// Capturar panics
// 	defer func() {
// 		if r := recover(); r != nil {
// 			log.Printf("PANIC CRITICO DETECTADO: %v", r)
// 			debug.PrintStack()
// 			os.Exit(1)
// 		}
// 	}()
...
// 	if config.Config.RabbitMQServers == "" {
// 		log.Fatalf("Variable RABBITMQ_SERVERS no está configurada correctamente")
// 	}
...
// 	// 	// log.Printf("Variable %s: %s", envVar, value)
// 	// 	if value == "" {
// 	// 		log.Fatalf("Variable de entorno %s no esta definida", envVar)
// 	// 	}
// 	// }
...
// 		} else {
// 			log.Printf("Error al conectar a RabbitMQ para enviar mensaje de prueba: %v", err)
// 		}
// 	}
